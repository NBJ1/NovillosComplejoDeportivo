	...
	<div class="container">
        ...
        <tbody>
            <tr>
                ...
                <td>61</td>
                <td>2011-04-25</td>
                <td><button class="btn btn-sm btn-primary me-2"  > <i class="bi-solid  bi-pencil"></i></button>
					<button class="btn btn-sm btn-danger" > <i class="bi-solid  bi-trash"></i></button>
				</td>
...
<style scoped>
	...
	.nav-link:hover{
		border-bottom:solid #4BB636;
		color:#4BB636 !important;
		border-radius: 4px;
    ...
    <v-app>
      <v-navigation-drawer right app color="rgb(255, 255, 255)" v-model="drawer">
        <v-layout column class="text-center"> 
            ...
            <div>
                <br>
                <img src="https://i.ibb.co/Z83YwGZ/icono-toro.png" alt="">
                Administrador
            </div>
